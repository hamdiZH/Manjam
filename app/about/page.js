...
const values = [
  {
    ...
    description: "Bank-grade security protocols protect every transaction and asset under our management.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    title: "Transparency",
    description: "Complete visibility into operations, fees, and performance with real-time reporting.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    title: "Consistency",
    description: "Disciplined processes ensure reliable execution across all market conditions.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    title: "Client Focus",
    description: "Every decision is made with our clients' best interests at the forefront.",
  },
];
...
const team = [
  ...
  { name: "Sarah Chen", role: "Chief Investment Officer", image: "/Avatar Base.png" },
  { name: "Michael Weber", role: "Head of Compliance", image: "/Avatar Base.png" },
...
const FeatureSection = ({ reverse = false, kicker, title, description, image }) => (
      ...
      <div className={`flex flex-col ${reverse ? "lg:flex-row-reverse" : "lg:flex-row"} items-center gap-12 lg:gap-20`}>
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[#46B886] font-semibold text-sm uppercase tracking-wider">{kicker}</span>
          </div>
          ...
          <div className="space-y-4">
            {["Swiss-regulated framework", "Shariah-compliant investments", "Institutional-grade security"].map((item, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <div className="w-6 h-6 rounded-full bg-[#ECFDF5] flex items-center justify-center">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                    <path d="M20 6L9 17l-5-5" stroke="#46B886" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div>
          <div className="flex items-center gap-3 mb-4">
            <span className="w-10 h-[2px] bg-[#46B886]" />
            <span className="text-[#46B886] font-semibold text-sm uppercase tracking-wider">Testimonials</span>
          </div>
          ...
          <p className="text-[#64748B] text-lg max-w-xl">
            Hear from qualified investors who trust Manjam with their digital asset journey.
          </p>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          { name: "Ahmad Al-Farsi", role: "Family Office Principal", quote: "Manjam provides the institutional rigor we require with full Shariah compliance. Their transparent approach sets them apart." },
          { name: "Sarah Mitchell", role: "Investment Manager", quote: "The platform's security and reporting capabilities exceed what we've seen from other digital asset managers." },
          { name: "Omar Hassan", role: "Private Investor", quote: "Finally, a digital asset solution that aligns with my values without compromising on professional standards." },
        ].map((testimonial, idx) => (
          <motion.div
            key={idx}
          ...
          >
            <Image src={`/blog${idx + 1}.png`} alt={testimonial.name} fill className="object-cover" />
            <div className="absolute inset-0 bg-linear-to-t from-[#0F172A] via-[#0F172A]/60 to-transparent" />
            
            {/* Content */}
            <div className="absolute bottom-0 left-0 right-0 p-6">
              {/* Quote Icon */}
              <svg className="w-8 h-8 text-[#46B886] mb-4 opacity-50" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full overflow-hidden ring-2 ring-[#46B886]/50">
                  <Image src="/Avatar Base.png" alt={testimonial.name} width={48} height={48} className="object-cover" />
                </div>
                <div>
      ...
      <section className="relative w-full pt-12 pb-20 sm:pt-16 sm:pb-24 lg:pt-20 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Manjam Capital combines Swiss institutional standards with Shariah-compliant principles to deliver a trusted digital asset ecosystem for qualified investors.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              >
                <Image src="/team.png" alt="Manjam Team" width={600} height={450} className="w-full h-auto" />
              </div>
              {/* Floating Card */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                ...
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-xl bg-[#ECFDF5] flex items-center justify-center">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                      <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" stroke="#14352D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M22 4L12 14.01l-3-3" stroke="#46B886" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <span className="w-10 h-[2px] bg-[#46B886]" />
                <span className="text-[#46B886] font-semibold text-sm uppercase tracking-wider">Our Mission</span>
              </div>
              <h2 className="text-[#0F172A] font-bold text-3xl sm:text-4xl lg:text-5xl leading-tight mb-6">
                Bridging tradition with innovation
              </h2>
              <p className="text-[#64748B] text-lg leading-relaxed mb-6">
                We believe that ethical investing and institutional excellence can coexist. Manjam Capital was founded to prove that qualified investors don&apos;t have to choose between their values and professional standards.
              </p>
              <p className="text-[#64748B] text-lg leading-relaxed">
                Our Swiss-regulated framework provides the security and transparency that institutional investors expect, while our Shariah-compliant approach ensures every investment aligns with ethical principles.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              <span className="w-8 h-[2px] bg-[#46B886]" />
              <span className="text-[#46B886] font-semibold text-sm uppercase tracking-wider">Our Values</span>
              <span className="w-8 h-[2px] bg-[#46B886]" />
            </div>
            <h2 className="text-[#0F172A] font-bold text-3xl sm:text-4xl lg:text-5xl leading-tight mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, idx) => (
              ...
              >
                ...
                <h3 className="text-[#0F172A] font-bold text-xl mb-3">{value.title}</h3>
      ...
      <section className="w-full py-16 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              <span className="w-8 h-[2px] bg-[#46B886]" />
              <span className="text-[#46B886] font-semibold text-sm uppercase tracking-wider">Leadership</span>
              <span className="w-8 h-[2px] bg-[#46B886]" />
            </div>
            <h2 className="text-[#0F172A] font-bold text-3xl sm:text-4xl lg:text-5xl leading-tight mb-4">
              Meet the team
            ...
            <p className="text-[#64748B] text-lg max-w-2xl mx-auto">
              Our leadership brings together expertise from traditional finance, blockchain technology, and Islamic finance.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, idx) => (
              ...
              >
                ...
                <h3 className="text-[#0F172A] font-bold text-lg mb-1">{member.name}</h3>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 text-base sm:text-lg mb-8 max-w-xl mx-auto">
                Join qualified investors who trust Manjam Capital for their digital asset needs.
              </p>
              <motion.a
                href="https://platform.manjamcapital.com/register/account-type"
